...
class CollectionModel {
    ...
    async count(query, options = {}) {
        try {
            ...
            let searchQuery = {};
            if (query.search) {
                searchQuery = util.makeSearchObject(query.search, this.searchFields, this.searchFieldsNum, options.useTextIndexCombined, options.searchType);
                delete query.search;
            }
            const finalQuery = {
                ...query,
    ...
    async countEstimated(query) {
        try {
            ...
            const total = await this.Model.estimatedDocumentCount(finalQuery);
            util.logFunctionTimer({
                file: 'collectionModel.js',
                class: this.modelName,
    ...
    async search(searchTerm, fields, options) {
        const { hrstart, runId } = util.startTimer();
        const query = util.makeSearchObject(searchTerm, this.searchFields, this.searchFieldsNum, options.useTextIndexCombined, options.searchType);
